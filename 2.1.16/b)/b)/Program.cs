...
namespace a_
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            inputB(out lengthB, out arrayB, out sumOfB,out flag);
            Algorithm(lengthA, lengthB, ref sumOfB, ref sumOfA, arrayA, arrayB);
            Output(sumOfB, sumOfA, ref flag);
            Console.ReadKey();
        }
        #region methods
        ...
        static void inputB(out int lengthB, out double[] arrayB, out double sumOfB,out bool flag)
        {
            flag = true;
        ...
        static void Output(double sumOfB,double sumOfA,ref bool flag)
        {
            if (sumOfA > sumOfB)
            {
                flag = false;
